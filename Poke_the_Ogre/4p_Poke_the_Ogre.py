...
def draw_text6(surface, text, size, x, y):
	font = pygame.font.SysFont("serif", size)
...
while running:
	...
	for p in p_list:
		if p.hp > 0:
			...
			if p == player4:
				draw_hp_bar4(screen, p.rect.x, p.rect.y - 10, p.hp//10)
	...
	draw_text6(screen, "P4 " + str(int(player4.damage)) , 10, 1050, 330)
